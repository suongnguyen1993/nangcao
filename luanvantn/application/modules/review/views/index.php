    ...
    <div class="logo-image">                                
       <a href="index.html"><img class="img-responsive" src="<?php echo base_url(); ?>/public/user/images/logo.png" alt=""> </a> 
    </div>
            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">                    
                    <div class="text-center coming-content">
                        <h1>Chức Năng đăng xây dựng,mời các bạn quay lại sau!!!</h1>
